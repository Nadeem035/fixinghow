...
class LanguageModel extends Model
{
    ...
    public function addLanguageSettings($langId)
    {
        $settings = [
            'lang_id' => $langId,
            'application_name' => "fixinghow",
            'site_title' => "fixinghow - Blog Magazine",
            'home_title' => "Index",
            'site_description' => "fixinghow - Blog Magazine",
            'keywords' => "fixinghow, Blog, Magazine",
            'primary_font' => 19,
            'secondary_font' => 25,
            'facebook_url' => "",
            'twitter_url' => "",
            ...
            'copyright' => "Copyright 2020 fixinghow - All Rights Reserved."
        ];
    ...
    {
        $page = [
            'lang_id' => $langId, 'title' => "Gallery", 'slug' => "gallery", 'page_description' => "fixinghow Gallery Page", 'page_keywords' => "fixinghow, gallery , page", 'is_custom' => 0, 'page_content' => "", 'page_order' => 2, 'page_active' => 1, 'title_active' => 1, 'breadcrumb_active' => 1, 'right_column_active' => 0, 'need_auth' => 0, 'location' => "header", 'parent_id' => 0
        ];
        $this->db->table('pages')->insert($page);
        $page = [
            'lang_id' => $langId, 'title' => "Contact", 'slug' => "contact", 'page_description' => "fixinghow Contact Page", 'page_keywords' => "fixinghow, contact, page", 'is_custom' => 0, 'page_content' => "", 'page_order' => 0, 'page_active' => 1, 'title_active' => 1, 'breadcrumb_active' => 1, 'right_column_active' => 0, 'need_auth' => 0, 'location' => "header", 'parent_id' => 0
        ];
        $this->db->table('pages')->insert($page);
        $page = [
            'lang_id' => $langId, 'title' => "Terms & Conditions", 'slug' => "terms-conditions", 'page_description' => "Terms & Conditions Page", 'page_keywords' => "fixinghow, terms, conditions, page", 'is_custom' => 0, 'page_content' => "", 'page_order' => 0, 'page_active' => 1, 'title_active' => 1, 'breadcrumb_active' => 1, 'right_column_active' => 0, 'need_auth' => 0, 'location' => "footer", 'parent_id' => 0
        ];
        $this->db->table('pages')->insert($page);
    }
